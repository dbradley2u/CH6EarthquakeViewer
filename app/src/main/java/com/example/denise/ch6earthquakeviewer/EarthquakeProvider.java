...
public class EarthquakeProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI =
            Uri.parse("content://com.example.denise.earthquakeprovider/earthquakes");
    ...
    static {
        ...
        uriMatcher.addURI("com.example.denise.earthquakeprovider", "earthquakes", QUAKES);
        uriMatcher.addURI("com.example.denise.earthquakeprovider", "earthquakes/#", QUAKE_ID);
        uriMatcher.addURI("com.example.denise.earthquakeprovider",
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case QUAKES  : return "vnd.android.cursor.dir/vnd.example.denise.earthquake";
            case QUAKE_ID: return "vnd.android.cursor.item/vnd.example.denise.earthquake";
